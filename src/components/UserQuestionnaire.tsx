...
const UserQuestionnaire = ({ onComplete, onSkip }) => {
  ...
  const handleComplete = () => {
    ...
    // Save to localStorage for the banner
              ...
              <div className="space-y-4">
                {recommendations.map((chapter, index) => (
                  <div
                    ...
                    onClick={() => {
                      // This will be handled by the gallery page to scroll to chapter
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 text-blue-600 text-sm font-medium hover:underline">
                          Start Reading →
                        </div>
                      </div>
                    </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Get personalized chapter recommendations</p>
              </div>
            </div>
            <button
              onClick={onSkip}
          ...
          {currentStep === 1 && (
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-gray-900 mb-2">🎯 What you'll get after completing this:</h4>
              <ul className="text-gray-700 text-sm space-y-1">
                <li>• Personalized chapter recommendations based on your specific needs</li>
                <li>• A custom roadmap prioritizing the most relevant content for your situation</li>
                <li>• Targeted advice for common mistakes in your industry and market</li>
              </ul>
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">What challenges do you face?</h3>
...
// Recommendation Banner Component (shows at top of gallery)
const RecommendationBanner = ({ recommendations, onNavigateToChapter, onDismiss }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Your Recommended Chapters</h3>
              <div className="flex flex-wrap gap-2 mt-1">
                {recommendations.slice(0, 3).map((rec, index) => (
                  <button
                    key={rec.id}
                    onClick={() => onNavigateToChapter(rec.id)}
                    className="text-sm bg-blue-100 text-blue-700 px-2 py-1 rounded hover:bg-blue-200 transition-colors"
                  >
                    Chapter {rec.id}: {rec.title}
                  </button>
                ))}
              </div>
            </div>
...
const useQuestionnaire = () => {
  ...
  const showQuestionnaire = () => setIsVisible(true);
  
  const handleComplete = (recs) => {
...
// Example of how to integrate in your signup component
const SignupIntegrationExample = () => {
  const { isVisible, showBanner, recommendations, showQuestionnaire, handleComplete, handleSkip, dismissBanner, navigateToChapter } = useQuestionnaire();

  // In your signup success handler, call:
  const handleSignupSuccess = () => {
    // Your existing signup logic...
    
    // Then show questionnaire
    showQuestionnaire();
  };
  ...
  return (
    <div>
      ...
      {/* Recommendation Banner - add this to your gallery page */}
      {showBanner && (
...
export { UserQuestionnaire, RecommendationBanner, useQuestionnaire };